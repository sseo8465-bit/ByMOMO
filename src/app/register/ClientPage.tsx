            ...
            <div className="mb-6 md:mb-8">
              ...
              <div className="flex gap-3 mb-3">
                <input
                  ...
                  readOnly
                  placeholder="우편번호"
                  className="flex-1 max-w-[140px] bg-[var(--cream)] border border-[var(--oatmeal)] outline-none px-3 py-3 text-[13px] md:text-[14px] font-[var(--font-ui)] font-normal text-[var(--charcoal)] placeholder:text-[var(--warm-taupe-light)] tracking-[0.02em] cursor-default"
                />
                <button
                  type="button"
                  onClick={openPostcode}
                  className="px-5 py-3 bg-[var(--charcoal)] text-[var(--cream)] text-[12px] md:text-[13px] font-[var(--font-ui)] font-medium tracking-[0.04em] hover:bg-[var(--walnut-dark)] transition-colors cursor-pointer"
                >
                  주소검색
                </button>
              </div>
              ...
              <input
                ...
                readOnly
                placeholder="기본주소"
                className="w-full bg-[var(--cream)] border border-[var(--oatmeal)] outline-none px-3 py-3 mb-3 text-[13px] md:text-[14px] font-[var(--font-ui)] font-normal text-[var(--charcoal)] placeholder:text-[var(--warm-taupe-light)] tracking-[0.02em] cursor-default"
              />
          ...
          <button
            ...
            className={`w-full py-4 md:py-5 text-[13px] md:text-[14px] font-[var(--font-ui)] font-bold tracking-[0.06em] transition-colors ${
              isFormValid && !isSubmitting
                ? 'bg-[var(--charcoal)] text-[var(--cream)] hover:bg-[var(--walnut-dark)] cursor-pointer'
